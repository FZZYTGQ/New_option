...
小赵学姐的黑科技 — 粘贴抖音 / B站 / 小红书 / 微信公众号分享内容，自动提取口播逐字稿或文章正文，并用 DeepSeek 按自定义规范生成 AI 总结。

## 功能

- 管理员后台开号，邮箱 + 密码登录
- 每账号默认 30 分钟额度，按 BibiGPT 计费时长扣减（视频按时长；公众号按正文折算）
- BibiGPT `getSubtitle` 提取口播逐字稿 / 公众号正文
